...
export default function DateRange({ dateRangeObj }: { dateRangeObj: DateRangeProps }) {
    ...
    return (
        <div className="flex items-center">
            ...
            />
            <button
                className="bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm ms-3 px-5 py-2.5 text-white dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                onClick={handleClick}
            >
                Apply
            </button>
            <button
                className="bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm ms-3 px-5 py-2.5 text-white dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800"
                onClick={handleClear}
            >
                Clear
            </button>
            <p className="ms-3 text-sm font-medium text-gray-900 dark:text-white">
