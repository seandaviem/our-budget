    ...
    return (
        ...
        >
            { isAdding ?
                <>
                    Adding
                    <svg aria-hidden="true" role="status" className="inline w-4 h-4 ms-3 text-gray-200 animate-spin dark:text-gray-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
