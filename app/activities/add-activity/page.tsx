        ...
        <>
            <main className="container mx-auto pb-48">
                ...
                <div className="text-white mt-10">
                    ...
                    <div className="mt-5">
                        <Link href="/activities" className="text-white focus:ring-4 font-medium rounded-lg text-sm px-5 py-2.5 bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-blue-800">View All Activities</Link>
                    </div>
                </div>
            </main>
